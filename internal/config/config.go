...
type Config struct {
	...
	DatabaseDSN          string        `hcl:"database_dsn" env:"DATABASE_DSN" default:"postgres://postgres:postgres@192.168.99.100:5432/postgres?sslmode=disable"`
	...
	OpenAIPromt          string        `hcl:"openai_prompt" env:"OPENAI_PROMPT"`
}
